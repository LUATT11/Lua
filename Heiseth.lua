                      ...
                      TextLabel_6.Text = "kevinsanne0430#0"
                      ...
                      names.Text = "Bienvenido al script de SoS, GLS"
                        ...
                        local function autoquest(boolean)
                          ...
                          revisarStats()
                            ...
                            revisarStats()-- revisa si tienes stats
                              if minimo >= 0 and minimo <4000 then
                                if v.Humanoid.Health >0 and v.Name  == "X Fighter" then
                                  textoEnemigo.Text = v.name
                                  SelectedQuests = "X Fighter Trainer"
                                  SelectedMobs = "X Fighter"
                                  return        
                                end
                          elseif minimo >=4000 and minimo <30000 then
                                if v.Humanoid.Health >0 and v.Name == "Klirin" then         
                                  SelectedQuests = v.name
                                  SelectedMobs = SelectedQuests
                                  return
                                end
                              elseif minimo >=30000 and minimo <39000 then
                                if v.Humanoid.Health >0 and v.Name == "Kid Nohag" then                              
                                  SelectedQuests = v.name
                                  SelectedMobs = SelectedQuests
                                  return                            
                                end
                              elseif minimo >=39000 and minimo < 50000 then
                                if v.Humanoid.Health >0 and v.Name == "Radish" then                                  
                                  SelectedQuests = v.name
                                  SelectedMobs = SelectedQuests
                                  return                       
                                end
                              elseif minimo >=50000 and minimo < 187500 then
                                if v.Humanoid.Health >0 and v.Name == "Mapa" then                                  
                                  SelectedQuests = v.name
                                  SelectedMobs = SelectedQuests
                                  return                                
                                end
                              elseif minimo >=187500 and minimo < 550000 then
                                if v.Humanoid.Health >0 and v.Name == "Super Vegetable" then                                  
                                  SelectedQuests = v.name
                                  SelectedMobs = SelectedQuests
                                  return                              
                                end
                                   elseif minimo >=550000 and minimo < 875000 then
                                if v.Humanoid.Health >0 and v.Name == "Chilly" then                                  
                                  SelectedQuests = v.name
                                  SelectedMobs = SelectedQuests
                                  return                              
                                end
                                  elseif minimo >=875000 and minimo < 1250000 then
                                if v.Humanoid.Health >0 and v.Name == "Perfect Atom" then                                  
                                  SelectedQuests = v.name
                                  SelectedMobs = SelectedQuests
                                  return                              
                                end
                           elseif minimo >=1250000 and minimo < 6025000 then
                                if v.Humanoid.Health >0 and v.Name == "SSJ2 Wukong" then                                  
                                  SelectedQuests = v.name
                                  SelectedMobs = SelectedQuests
                                  return                              
                                end
                             elseif minimo >=6025000 and minimo < 8000000 then
                                if v.Humanoid.Health >0 and v.Name == "Kai-fist Master" then                                  
                                  SelectedQuests = v.name
                                  SelectedMobs = SelectedQuests
                                  return                              
                                end
                                ...
                                elseif minimo >=1000000000 and minimo < 1600000000 then
                                if v.Humanoid.Health >0 and v.Name == "Vis (20%)" then                                  
                                  SelectedQuests = v.name
                                  SelectedMobs = SelectedQuests
                                  return                              
                                end
                                  elseif minimo >=1600000000 and minimo < 3000000000 then
                                if v.Humanoid.Health >0 and v.Name == "Vegetable (LBSSJ4)" then                                  
                                  SelectedQuests = v.name
                                  SelectedMobs = SelectedQuests
                                  return                              
                                end
                                   elseif minimo >=3000000000 and minimo < 3700000000 then
                                if v.Humanoid.Health >0 and v.Name == "Wukong (LBSSJ4)" then                                  
                                  SelectedQuests = v.name
                                  SelectedMobs = SelectedQuests
                                  return                              
                                end
                                  elseif minimo >=3700000000 and minimo < 4500000000 then
                                if v.Humanoid.Health >0 and v.Name == "Vekuta (LBSSJ4)" then                                  
                                  SelectedQuests = v.name
                                  SelectedMobs = SelectedQuests
                                  return                              
                                end
                                  elseif minimo >=4500000000 and minimo < 5000000000 then
                                if v.Humanoid.Health >0 and v.Name == "Wukong Rose" then                                  
                                  SelectedQuests = v.name
                                  SelectedMobs = SelectedQuests
                                  return                              
                                end
